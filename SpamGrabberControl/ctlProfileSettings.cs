...
namespace SpamGrabberControl
{
    public partial class ctlProfileSettings : UserControl
    {
        ...
        private void LoadSettings()
        {
            ...
            chkIncludeIP.Checked = this._objProfile.IncludeIPAddress;
            ...
            chkFixMime.Checked = this._objProfile.FixMIME;
        }
        ...
        private void ctlProfileSettings_Load(object sender, EventArgs e)
        {
            ...
            ttProfileSettings.SetToolTip(chkFixMime, "Tells SpamGrabber to process the selected messages \r\nand fix the mess Outlook makes when interpreting the message. " +
                                                        "\r\nThis will in most cases give the spamfilters \r\nthe best material to work with.");
            ttProfileSettings.SetToolTip(chkIncludeIP, "Tells SpamGrabber to include all your IP4 addresses in the report.");
        ...
        private void chkIncludeIP_CheckedChanged(object sender, EventArgs e)
        {
            this._objProfile.IncludeIPAddress = chkIncludeIP.Checked;
        }
        ...
        private void chkFixMime_CheckedChanged(object sender, EventArgs e)
        {
            this._objProfile.FixMIME = chkFixMime.Checked;
        }
