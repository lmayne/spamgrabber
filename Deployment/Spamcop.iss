...
AppVersion=4.0.8
AppPublisher=Spamgrabber
AppPublisherURL=http://www.spamgrabber.org
AppSupportURL=http://www.spamgrabber.org
AppUpdatesURL=http://www.spamgrabber.org
CreateAppDir=true
OutputBaseFilename=Spamgrabbersetup
Compression=lzma
...
[Files]
Source: SpamGrabberSetup.msi; DestDir: {app}; Flags: ignoreversion
...
Filename: msiexec.exe; Parameters:" /i ""{app}\SpamGrabberSetup.msi"" /qn"; Check: (CheckInstallSpamgrabber()); Flags: skipifnotsilent; StatusMsg: Installing Spamgrabber...
Filename: msiexec.exe; Parameters:" /i ""{app}\SpamGrabberSetup.msi"""; Check: (CheckInstallSpamgrabber()); Flags: skipifsilent; StatusMsg: Installing Spamgrabber...

[UninstallRun]
Filename: msiexec.exe; Parameters:" /x ""{app}\SpamGrabberSetup.msi"" /qn"; Check: (CheckInstallSpamgrabber()); StatusMsg: Installing Spamgrabber...
