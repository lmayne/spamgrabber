...
{
    //Softscan report address: "blacknwhite@report.softscan.dk"
    ...
    public class Profile
    {
        ...
        public enum eProfileType { SpamProfile, HamProfile, SpamHamProfile }

        private string _strProfileName;
        private string _strProfileId;
        private bool? _blnCleanHeaders;
        private ArrayList _arrToAddresses;
        private ArrayList _arrBccAddresses;
        ...
        private bool? _blnIncludeIPAddress;
        private bool? _blnUseRFC;
        private bool? _blnSendReceiveAfterReport;
        private bool? _blnFixMIME;
        private bool? _blnReportToAllProfiles;
        ...
        /// </summary>
        public ArrayList ToAddresses
        {
            get
            {
                if (this._arrToAddresses == null)
                {
                    this._arrToAddresses = new ArrayList();
                }
        ...
        /// </summary>
        public ArrayList BccAddresses
        {
            get
            {
                if (this._arrBccAddresses == null)
                {
                    this._arrBccAddresses = new ArrayList();
                }
        ...
        /// <summary>
        /// Whether or not to include the client's IP address in the report filename
        /// </summary>
        public bool IncludeIPAddress
        {
            get
            {
                if (this._blnIncludeIPAddress == null)
                {
                    // Default
                    this._blnIncludeIPAddress = false;
                }
                return (bool)this._blnIncludeIPAddress;
            }
            set
            {
                this._blnIncludeIPAddress = value;
            }
        }
        ...
        /// <summary>
        /// Should we run the mime fix when creating the mail.
        /// </summary>
        public bool FixMIME
        {
            get
            {
                if (this._blnFixMIME == null)
                {
                    // Default
                    this._blnFixMIME = false;
                }
                return (bool)this._blnFixMIME;
            }
            set
            {
                this._blnFixMIME = value;
            }
        }

        /// <summary>
        /// Should we process all the profiles of a type when reporting?
        /// </summary>
        public bool ReportToAllProfiles
        {
            get
            {
                if (this._blnReportToAllProfiles == null)
                {
                    // Default
                    this._blnReportToAllProfiles = false;
                }
                return (bool)this._blnReportToAllProfiles;
            }
            set
            {
                this._blnReportToAllProfiles = value;
            }
        }
        ...
        /// <summary>
        /// The profile type is used to identify Spam/Ham profiles
        /// </summary>
        public eProfileType ProfileType
        {
            get {
                return this._eProfileType;
            }
            set {
                this._eProfileType = value;
            }
        }
        ...
        private void LoadProfile()
        {
            ...
            this._blnIncludeIPAddress = (bool)SGGlobals.LoadValue(strKey, "IncludeIPAddress", false);
            ...
            this._blnFixMIME = (bool)SGGlobals.LoadValue(strKey, "FixMIME", false);
            this._blnReportToAllProfiles = (bool)SGGlobals.LoadValue(strKey, "ReportToAllProfiles", false);
            this._eProfileType =(Profile.eProfileType)SGGlobals.LoadValue(strKey, "ProfileType", 0);
            ...
            {
                this._arrToAddresses.Add(strAddress);
            }
            ...
            {
                this._arrBccAddresses.Add(strAddress);
            }
        }
        ...
        public void Save()
        {
            ...
            SGGlobals.SaveSetting(strKey, "IncludeIPAddress", this.IncludeIPAddress);
            ...
            SGGlobals.SaveSetting(strKey, "FixMIME", this.FixMIME);
            SGGlobals.SaveSetting(strKey, "ReportToAllProfiles", this.ReportToAllProfiles);
            SGGlobals.SaveSetting(strKey, "ProfileType", (Int32)this.ProfileType);
