...
namespace SpamGrabberCommon
{
    ...
    public class GlobalSettings
    {
        ...
        private static bool? _blnShowSupportButton = null;
        ...
        private static bool? _blnUseStandardToolbar = null;
        ...
        private static bool? _blnReportToMultipleProfiles = null;
        ...
        /// <summary>
        /// Whether or not the Support button should be displayed
        /// </summary>
        public static bool ShowSupportButton
        {
            get
            {
                // If the value has not been populated...
                if (_blnShowSupportButton == null)
                {
                    // ...get it from the registry
                    _blnShowSupportButton = SGGlobals.LoadValue(SGGlobals.BaseRegistryKey, "ShowSupportButton", true);
                }
                return (bool)_blnShowSupportButton;
            }
            set
            {
                _blnShowSupportButton = value;
            }
        }
        ...
        /// <summary>
        /// Embeds the SpamGrabber buttons into the standard toolbar. If
        /// set to false then a new tollbar is used.
        /// </summary>
        public static bool UseStandardToolbar
        {
            get
            {
                // If the value has not been populated...
                if (_blnUseStandardToolbar == null)
                {
                    // ...get it from the registry
                    _blnUseStandardToolbar = SGGlobals.LoadValue(SGGlobals.BaseRegistryKey, "UseStandardToolbar", false);
                }
                return (bool)_blnUseStandardToolbar;
            }
            set
            {
                _blnUseStandardToolbar = value;
            }
        }
        ...
        /// <summary>
        /// Should the application be able to report to more than one profile at the time.
        /// </summary>
        public static bool ReportToMultipleProfiles
        {
            get
            {
                // If the value has not been populated...
                if (_blnReportToMultipleProfiles == null)
                {
                    // ...get it from the registry
                    _blnReportToMultipleProfiles = SGGlobals.LoadValue(SGGlobals.BaseRegistryKey, "ReportToMultipleProfiles", false);
                }
                return (bool)_blnReportToMultipleProfiles;
            }
            set
            {
                _blnReportToMultipleProfiles = value;
            }
        }
        ...
        public static void Save()
        {
            ...
            SGGlobals.SaveSetting(SGGlobals.BaseRegistryKey, "UseStandardToolbar", UseStandardToolbar);
            ...
            SGGlobals.SaveSetting(SGGlobals.BaseRegistryKey, "ReportToMultipleProfiles", ReportToMultipleProfiles);
        ...
        public static void LoadSettings()
        {
            ...
            _blnUseStandardToolbar = SGGlobals.LoadValue(strKey, "UseStandardToolbar", false);
            _blnReportToMultipleProfiles = SGGlobals.LoadValue(strKey, "ReportToMultipleProfiles", false);
        }
